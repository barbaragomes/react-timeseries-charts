...
var Brush = (function(_React$Component) {
    ...
    _createClass(Brush, [
        ...
        },
        {
            ...
            value: function handleHandleMouseDown(e, handle, brush_idx) {
                e.preventDefault();
                ...
                var xy0 = [Math.round(x), Math.round(y)];
                var begin = this.props.timeRanges[brush_idx].begin().getTime();
                var end = this.props.timeRanges[brush_idx].end().getTime();
        ...
        },
        {
            ...
            value: function renderBrush(timeRange, idx) {
                ...
                var brushStyle = (0, _merge2.default)(true, brushDefaultStyle, styles[idx]);
                    ...
                    return _react2.default.createElement(
                        ...
                        _extends({}, bounds, {
                            ...
                            onMouseDown: function onMouseDown(e) {
                                return _this3.handleBrushMouseDown(e, idx);
                            },
                            onMouseUp: this.handleMouseUp
                        })
                    );
                    ...
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _extends({}, leftHandleBounds, {
                                ...
                                pointerEvents: "all",
                                onMouseDown: function onMouseDown(e) {
                                    return _this4.handleHandleMouseDown(e, "left", idx);
                                },
                                onMouseUp: this.handleMouseUp
                            })
                        ),
                        _react2.default.createElement(
                            ...
                            _extends({}, rightHandleBounds, {
                                ...
                                pointerEvents: "all",
                                onMouseDown: function onMouseDown(e) {
                                    return _this4.handleHandleMouseDown(e, "right", idx);
                                },
                                onMouseUp: this.handleMouseUp
                            })
                        )
                ...
                return _react2.default.createElement(
                    ...
                    (this.props.timeRanges || []).map(function(timeRange, idx) {
                        return _react2.default.createElement(
                            "g",
                            { key: "brush_" + idx },
                            _this5.renderBrush(timeRange, idx),
                            _this5.renderHandles(timeRange, idx)
                        );
                    })
                );
            }
...
Brush.propTypes = {
     ...
     */
    styles: _propTypes2.default.object, //eslint-disable-line
    /**
